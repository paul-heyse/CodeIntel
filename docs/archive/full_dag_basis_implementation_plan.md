...
| analytics | `analytics/dependency_targets.py`      | `external_deps`, `entrypoints`                                                                                                           | tables                                       | de-scoped                         | Removed from Hamilton scope; no registry contract and redundant with config/dep tables.                                                                                                          |
...
| analytics | `analytics/metrics_targets.py`         | `subsystem_graph_metrics`, `symbol_graph_metrics`, `subsystem_agreement`, `test_graph_metrics`                                           | tables                                       | **TO**                            | All TO (rows). If you later enforce “tool boundary nodes” for git/test runtime, you still keep TO because outputs are tables.                                                                    |
