...
The script executes Ruff, Pyright, and Pyrefly under `uv run`, captures their outputs,
and serializes a machine-friendly report for downstream agents.
"""
...
class CommandResult:
    ...
    def to_payload(self) -> CommandResultPayload:
        ...
        CommandResultPayload
            Serialized representation of this command result.
        """
...
def generate_report(results: list[CommandResult], output_path: Path) -> QualityReportPayload:
    ...
    QualityReportPayload
        Structured summary including overall status and per-command results.
    """
...
def parse_args() -> Path:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "(default: build/quality-results/quality_report.json)"
        ),
    )
