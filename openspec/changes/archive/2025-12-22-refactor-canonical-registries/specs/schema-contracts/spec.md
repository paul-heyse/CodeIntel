...
- Done: declared schemas are source-only, centralized row serialization and contract-derived
  JSON Schema generation are in place, and shared contract validation is implemented across
