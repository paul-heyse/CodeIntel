...
- Done: ingestion compute steps are Hamilton-only; public ingestion APIs expose tool execution
  interfaces, and legacy discovery registry surfaces are removed in favor of canonical catalogs.
