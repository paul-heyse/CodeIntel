...
FULL_PYTHON_RECIPE = recipe(
    ...
    stages=[
        stage(
            name="scan",
            plugins=["repo_scan"],
            description="Scan repository structure and build module index.",
        ),
        stage(
            name="parse",
            plugins=["ast_extract", "cst_extract"],
            parallel=True,
            description="Parse Python AST and CST structures.",
        ),
        stage(
            name="index",
            plugins=["scip_ingest"],
            description="Generate SCIP index for semantic analysis.",
        ),
        stage(
            name="enrich",
            plugins=[
            ...
            parallel=True,
            description="Enrich with typing, coverage, tests, and docstrings.",
        ),
    ],
...
INCREMENTAL_RECIPE = recipe(
    ...
    stages=[
        stage(
            name="scan",
            plugins=["repo_scan"],
            description="Scan for changed modules.",
        ),
        stage(
            name="parse",
            plugins=["ast_extract", "cst_extract"],
            parallel=True,
            description="Parse changed modules.",
        ),
        stage(
            name="enrich",
            plugins=["typing_ingest", "docstrings_ingest"],
            parallel=True,
            description="Update typing and docstrings for changed modules.",
        ),
    ],
    options=RecipeOptions(
        enable_incremental=True,
...
MINIMAL_RECIPE = recipe(
    ...
    stages=[
        ...
        stage(
            name="parse",
            plugins=["ast_extract"],
            description="Parse AST for basic analysis.",
        ),
    ],
    options=RecipeOptions(
...
CORE_ONLY_RECIPE = recipe(
    ...
    stages=[
        ...
        stage(
            ...
            plugins=["ast_extract", "cst_extract"],
            parallel=True,
            description="Parse AST and CST.",
        ),
        stage(
            name="enrich",
            plugins=["docstrings_ingest", "config_ingest"],
            parallel=True,
            description="Extract docstrings and config.",
        ),
    ],
    options=RecipeOptions(
        enable_incremental=True,
...
ANALYSIS_RECIPE = recipe(
    ...
    stages=[
        ...
        stage(
            ...
            parallel=True,
            description="Enrich with typing and docstrings.",
        ),
    ],
    options=RecipeOptions(
        enable_incremental=True,
