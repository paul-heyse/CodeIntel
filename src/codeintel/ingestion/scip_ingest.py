"""Generate SCIP indexes and register them for downstream analytics."""
...
def ingest_scip(
    ...
    *,
    ...
    """
    Run scip-python to build an index.scip and JSON view.
    ...
    -------
    Path | None
        Path to `index.scip.json` when generation succeeds; otherwise None.
    """
