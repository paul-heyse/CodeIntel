...
types for lazy resource loading in the ingestion system.
"""
...
class ResourceProvider[T_co](Protocol):
    ...
    (modules, trackers, tools). Resources are loaded on first access
    ...
    def invalidate(self) -> None:
        ...
        Force the resource to be reloaded on next access.
        """
        ...
...
class LazyResource[T](ABC):
    ...
    Provide a standard implementation of lazy loading with caching.
