...
from codeintel.build.analytics.compute.graphs.projections import community_ids
from codeintel.build.analytics.compute.graphs.types import StructuralMetrics
