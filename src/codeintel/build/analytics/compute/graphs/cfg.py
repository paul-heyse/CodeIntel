...
from codeintel.build.analytics.compute.graphs.centrality import centrality_directed
from codeintel.build.analytics.compute.graphs.types import DominanceMetrics
...
if TYPE_CHECKING:
    from codeintel.build.analytics.compute.graphs.types import CentralityBundle
