...
if TYPE_CHECKING:
    ...
    from codeintel.build.hamilton.native.ingestion.syntax_augment import (
        t__syntax_augment,
    )
...
_LAZY_IMPORTS = {
    ...
    "t__bytecode": "codeintel.build.hamilton.native.ingestion.extraction_targets",
    "t__bytecode__ingest": "codeintel.build.hamilton.native.ingestion.extraction_targets",
    "t__bytecode__run": "codeintel.build.hamilton.native.ingestion.extraction_targets",
    ...
    "t__inspect": "codeintel.build.hamilton.native.ingestion.extraction_targets",
    "t__inspect__ingest": "codeintel.build.hamilton.native.ingestion.extraction_targets",
    "t__inspect__run": "codeintel.build.hamilton.native.ingestion.extraction_targets",
    ...
    "t__syntax_augment": "codeintel.build.hamilton.native.ingestion.syntax_augment",
    ...
    "t__symtable": "codeintel.build.hamilton.native.ingestion.extraction_targets",
    "t__symtable__ingest": "codeintel.build.hamilton.native.ingestion.extraction_targets",
    "t__symtable__run": "codeintel.build.hamilton.native.ingestion.extraction_targets",
