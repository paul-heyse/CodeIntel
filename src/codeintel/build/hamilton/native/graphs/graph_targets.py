...
_CALL_GRAPH_TABLE_TARGET_SPEC = build_multi_table_target_spec(
...
_IMPORT_GRAPH_TABLE_TARGET_SPEC = build_multi_table_target_spec(
    context=MultiTableTargetContext(
        domain="graphs",
...
_CFG_TABLE_TARGET_SPEC = build_multi_table_target_spec(
    context=MultiTableTargetContext(
        domain="graphs",
...
_CALL_WIRING_TABLE_TARGET_SPEC = build_multi_table_target_spec(
    context=MultiTableTargetContext(
        domain="graphs",
...
_CPG_TABLE_TARGET_SPEC = build_multi_table_target_spec(
    context=MultiTableTargetContext(
        domain="graphs",
