...
def _component_infos(components: Sequence[Collection[Any]]) -> list[ComponentInfo]:
...
def _membership_from_components(components: Sequence[Collection[Any]]) -> dict[Any, int]:
