...
.. deprecated::
    This module is being deprecated. Use the following alternatives:
    - DatasetContract, RowBinding: import from codeintel.core.schemas.contract_primitives
    - get_dataset_contracts: use codeintel.build.schemas.iter_contracts()
    - get_dataset_contracts_by_table_key: use codeintel.build.schemas.iter_contracts_by_table_key()
    - get_table_schemas: use codeintel.build.schemas.get_schema_provider()
"""
...
# Re-export DatasetContract and RowBinding from canonical location
