...
This module provides error types for plugin execution, including
fatal errors, timeouts, and skip signals.
"""
...
"""Exception types that plugins may catch and handle gracefully."""
