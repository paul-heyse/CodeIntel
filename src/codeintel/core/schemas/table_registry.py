...
TABLE_SCHEMAS: dict[str, TableSchema] = {
    ...
    "build.contract_alignment_issues": TableSchema(
        schema="build",
        name="contract_alignment_issues",
        columns=[
            Column("run_id", "VARCHAR", nullable=False, description="Parent run identifier"),
            Column("repo", "VARCHAR", nullable=False, description="Repository slug"),
            Column("commit", "VARCHAR", nullable=False, description="Commit SHA"),
            Column("target_name", "VARCHAR", nullable=False, description="Target name"),
            Column("table_key", "VARCHAR", nullable=False, description="Aligned table key"),
            Column(
                "missing_columns",
                "LIST(VARCHAR)",
                nullable=False,
                description="Contract columns missing from the output",
            ),
            Column(
                "extra_columns",
                "LIST(VARCHAR)",
                nullable=False,
                description="Output columns not present in the contract",
            ),
            Column(
                "coerced_columns",
                "LIST(VARCHAR)",
                nullable=False,
                description="Columns requiring type coercion to match the contract",
            ),
            Column(
                "missing_count",
                "INTEGER",
                nullable=False,
                description="Count of missing columns",
            ),
            Column(
                "extra_count",
                "INTEGER",
                nullable=False,
                description="Count of extra columns",
            ),
            Column(
                "coerced_count",
                "INTEGER",
                nullable=False,
                description="Count of coerced columns",
            ),
            Column(
                "row_count",
                "INTEGER",
                description="Observed row count when alignment was reported",
            ),
            Column("contract_hash", "VARCHAR", description="Schema hash for the table contract"),
            Column(
                "contract_version",
                "VARCHAR",
                description="Schema version for the table contract",
            ),
            Column(
                "recorded_at",
                "TIMESTAMPTZ",
                nullable=False,
                description="When the alignment report was recorded",
            ),
        ],
    ...
    "build.join_precheck_issues": TableSchema(
        schema="build",
        name="join_precheck_issues",
        columns=[
            Column("run_id", "VARCHAR", nullable=False, description="Parent run identifier"),
            Column("repo", "VARCHAR", nullable=False, description="Repository slug"),
            Column("commit", "VARCHAR", nullable=False, description="Commit SHA"),
            Column("target_name", "VARCHAR", nullable=False, description="Target name"),
            Column("table_key", "VARCHAR", nullable=False, description="Source table key label"),
            Column(
                "join_keys",
                "LIST(VARCHAR)",
                nullable=False,
                description="Join key columns validated during precheck",
            ),
            Column(
                "join_key_signature",
                "VARCHAR",
                nullable=False,
                description="Stable join key signature for grouping",
            ),
            Column("error_code", "VARCHAR", nullable=False, description="Error code"),
            Column("stage", "VARCHAR", nullable=False, description="Finalize error stage"),
            Column("column", "VARCHAR", nullable=False, description="Failing column"),
            Column("detail", "VARCHAR", nullable=False, description="Error detail message"),
            Column(
                "row_id",
                "BIGINT",
                nullable=False,
                description="Row identifier within the precheck input",
            ),
            Column(
                "key_payload",
                "BLOB",
                nullable=False,
                description="Encoded join-key values for the failing row",
            ),
            Column(
                "recorded_at",
                "TIMESTAMPTZ",
                nullable=False,
                description="When the join precheck error was recorded",
            ),
        ],
    ...
    "build.empty_dataset_issues": TableSchema(
        schema="build",
        name="empty_dataset_issues",
        columns=[
            Column("run_id", "VARCHAR", nullable=False, description="Parent run identifier"),
            Column("repo", "VARCHAR", nullable=False, description="Repository slug"),
            Column("commit", "VARCHAR", nullable=False, description="Commit SHA"),
            Column("table_key", "VARCHAR", nullable=False, description="Dataset table key"),
            Column(
                "required_min_rows",
                "INTEGER",
                nullable=False,
                description="Minimum required rows for non-empty status",
            ),
            Column("row_count", "INTEGER", description="Row count observed from manifest"),
            Column("status", "VARCHAR", nullable=False, description="Guardrail status"),
            Column(
                "dependency_chain",
                "LIST(VARCHAR)",
                nullable=False,
                description="Target dependency chain for this dataset",
            ),
            Column(
                "recorded_at",
                "TIMESTAMPTZ",
                nullable=False,
                description="When the empty dataset issue was recorded",
            ),
        ],
