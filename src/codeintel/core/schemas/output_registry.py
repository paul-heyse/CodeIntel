...
COVERAGE_INGEST_OVERRIDE_TABLES: tuple[TableSchema, ...] = (
    TableSchema(
        schema="analytics",
        name="coverage_lines",
        columns=[
...
BEHAVIORAL_COVERAGE_OVERRIDE_TABLES: tuple[TableSchema, ...] = (
    TableSchema(
        schema="analytics",
...
COVERAGE_TEST_EDGES_OVERRIDE_TABLES: tuple[TableSchema, ...] = (
    TableSchema(
        schema="analytics",
...
COVERAGE_FUNCTIONS_OVERRIDE_TABLES: tuple[TableSchema, ...] = (
    TableSchema(
        ...
        description="Per-function coverage summary derived from coverage lines.",
    ),
)
...
RISK_FACTORS_OVERRIDE_TABLES: tuple[TableSchema, ...] = (
    TableSchema(
        ...
        description="Per-function risk factors derived from complexity and tests.",
    ),
)
...
PROFILES_OVERRIDE_TABLES: tuple[TableSchema, ...] = (
    TableSchema(
        schema="analytics",
        ...
        description=(
            "Denormalized per-function profile combining risk, coverage, tests, docs, "
            "and graph metrics"
        ),
    ),
    TableSchema(
...
SUBSYSTEM_CACHE_OVERRIDE_TABLES: tuple[TableSchema, ...] = (
    ...
    TableSchema(
        ...
        primary_key=("repo", "commit", "subsystem_id"),
        description="Cached subsystem test coverage aggregates.",
    ),
)
...
TEST_GRAPH_METRICS_OVERRIDE_TABLES: tuple[TableSchema, ...] = (
    TableSchema(
        schema="analytics",
...
TEST_PROFILE_OVERRIDE_TABLES: tuple[TableSchema, ...] = (
    TableSchema(
        schema="analytics",
        name="test_profile",
        columns=[
        ...
        description=(
            "Per-test profile combining execution status, coverage footprint, AST metrics, "
            "IO usage, and flakiness/importance heuristics."
        ),
    ),
)
