...
from codeintel.analytics.core.plugins.coverage.functions import CoverageFunctionsPlugin
from codeintel.analytics.core.plugins.coverage.test_edges import CoverageTestEdgesPlugin
