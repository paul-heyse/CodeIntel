...
Example
-------
>>> from codeintel.analytics.core.plugins.middleware import LoggingMiddleware
...
from codeintel.analytics.core.plugins.middleware.protocol import (
    MiddlewareChain,
    PluginMiddleware,
)
from codeintel.analytics.core.plugins.middleware.tracing import TracingMiddleware
