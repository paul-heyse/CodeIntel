"""Bridge module for build system integration with the unified plugin system.

This module provides functions that allow the build executor to run
analytics plugins via the unified plugin system.
"""
