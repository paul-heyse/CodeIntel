...
import duckdb
from mcp.server.fastmcp import FastMCP  # official Python SDK quickstart :contentReference[oaicite:7]{index=7}
...
def get_callgraph_neighbors(
    ...
    """
    Get static call graph neighbors of a function, from the view
...
def get_file_summary(
    ...
    """
    Summarize a file and the functions it contains, using docs.v_file_summary
    and docs.v_function_summary.
...
def list_datasets() -> List[dict]:
    """
    List key datasets (tables/views) available for inspection, suitable for
    small sampling via read_dataset_rows.
    """
