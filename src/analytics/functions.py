...
class _FunctionStats(ast.NodeVisitor):
    """
    Collects per-function structural stats for cyclomatic complexity,
    nesting depth, and counts of returns/yields/raises. 
    """
...
def compute_function_metrics_and_types(
    ...
    using GOIDs (core.goids) and the underlying Python AST. 
    """
