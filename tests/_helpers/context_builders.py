...
This module provides builder classes for constructing complex test data
objects with sensible defaults and a fluent interface.
"""
...
class FunctionContextBuilder:
    ...
    Creates FunctionContext instances with sensible defaults for testing
