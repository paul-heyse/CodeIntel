...
def _get_declared_schemas(runtime: HamiltonRuntimeBundle) -> dict[str, TableSchema]:
...
def _get_schema_index(runtime: HamiltonRuntimeBundle) -> SchemaIndex:
...
def _declared_source_keys(runtime: HamiltonRuntimeBundle) -> list[str]:
...
def _non_inferable_table_key(runtime: HamiltonRuntimeBundle) -> str | None:
...
def test_unified_provider_is_cached(hamilton_runtime: HamiltonRuntimeBundle) -> None:
...
def test_clear_unified_provider_cache_works(hamilton_runtime: HamiltonRuntimeBundle) -> None:
...
def test_inferable_table_keys_not_empty(hamilton_runtime: HamiltonRuntimeBundle) -> None:
...
def test_schema_index_covers_target_table_keys(hamilton_runtime: HamiltonRuntimeBundle) -> None:
...
def test_unified_provider_has_declared_fallback(hamilton_runtime: HamiltonRuntimeBundle) -> None:
...
def test_unified_provider_caches_resolved_schemas(hamilton_runtime: HamiltonRuntimeBundle) -> None:
...
def test_unified_provider_has_dataclass_fields(hamilton_runtime: HamiltonRuntimeBundle) -> None:
...
def test_catalog_output_schemas_accessible(hamilton_runtime: HamiltonRuntimeBundle) -> None:
