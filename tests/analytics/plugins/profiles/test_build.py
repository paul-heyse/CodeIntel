...
def test_profiles_plugin_metadata_capabilities_provided() -> None:
    ...
    assert "analytics.function_profile" in plugin.metadata.provides
    assert "analytics.file_profile" in plugin.metadata.provides
    assert "analytics.module_profile" in plugin.metadata.provides
