...
from codeintel.analytics.core.plugin_protocol import PluginMetadata
from codeintel.analytics.core.plugins.groups import (
    ALL_GROUPS,
    FUNCTION_PLUGINS,
    GRAPH_PLUGINS,
    RISK_PLUGINS,
...
from codeintel.analytics.core.plugins.groups.protocol import GroupRegistry
