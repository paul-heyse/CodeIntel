...
class TestConfigMapping:
    """Tests for ConfigMapping dataclass."""
    ...
    def test_create_with_field_map(self) -> None:
    ...
    def test_frozen_dataclass(self) -> None:
        ...
        with pytest.raises(AttributeError):
            mapping.auto_infer = False  # type: ignore[misc]
...
class TestBuildOptions:
    ...
    def test_frozen_dataclass(self) -> None:
        ...
        with pytest.raises(AttributeError):
            options.mapping = {}  # type: ignore[misc]


class TestGetConfigFields:
    """Tests for get_config_fields function."""
    ...
    def test_non_dataclass_fields(self) -> None:
    ...
    def test_config_with_many_fields(self) -> None:
...
class TestInferConfigMapping:
    """Tests for infer_config_mapping function."""

    def test_infer_basic_mapping(self) -> None:
    ...
    def test_infer_mapping_with_tools(self) -> None:
    ...
    def test_infer_mapping_non_dataclass(self) -> None:
...
class TestConfigFactory:
    ...
    def test_create_with_default_mappings(self) -> None:
        """Test creating factory with default mappings."""
        factory = ConfigFactory()

        # The factory should have the default mappings
        assert factory._default_mappings == dict(DEFAULT_CONTEXT_MAPPINGS)

    def test_create_with_custom_mappings(self) -> None:
        ...
        assert factory._default_mappings == custom_mappings

    def test_build_simple_config(self) -> None:
    ...
    def test_build_with_extra_values(self) -> None:
    ...
    def test_build_with_custom_mapping(self) -> None:
    ...
    def test_build_with_tracker(self) -> None:
    ...
    def test_build_with_tool_service(self) -> None:
    ...
    def test_build_with_tools_from_context(self) -> None:
    ...
    def test_build_non_dataclass_config(self) -> None:
        """Test building a non-dataclass config."""
        factory = ConfigFactory()
        ctx = MockContext()

        config = factory.build(NonDataclassConfig, ctx)  # type: ignore[arg-type]
    ...
    def test_build_ignores_unknown_extra_fields(self) -> None:
...
class TestGetContextValue:
    """Tests for _get_context_value helper function (via ConfigFactory)."""
    ...
    def test_tracker_from_options_takes_precedence(self) -> None:
...
class TestDefaultContextMappings:
    """Tests for DEFAULT_CONTEXT_MAPPINGS constant."""
    ...
    def test_mappings_are_identity(self) -> None:
